        ...
        <div class="card-content">
          <div class="media">
            ...
            <div class="media-content">
              <p class="title is-4">{{ projet.name }}</p>
              <p class="subtitle is-6">{{ projet.typeDeProjet }}</p>
            </div>
          </div>
    ...
    return {
      projets: [
        ...
        },
        {
          ...
          item1: "Lien vers le site web",
          item2: "Lien vers le site web (.com)",
          lienGit: "https://metahomeopathie.fr/",
          lienWeb: "https://metahomeopathie.com/",
